					...
					<?php echo do_shortcode('[widgetkit id=10]') ?>
							...
							<div class="section group">
								<div class="col span_4_of_12">
									<a href="#" class="box_a"><img src="<?php echo get_template_directory_uri(); ?>/camouflage/forcenter/images/box1.png" alt="forcenter"/></a>
								</div>
								<div class="col span_4_of_12">
									<a href="#" class="box_b">
								...
								<div class="col span_4_of_12">
									<div class="box_c">
										<a href="#" class="title">
											...
											<span><img src="<?php echo get_template_directory_uri(); ?>/camouflage/forcenter/images/box_arrow.png" alt="forcenter"/></span>
										</a>
										<span class="bg">&nbsp;</span>
