...
?> 
	...
	<div id="toolbar">
		<div class="toolbar-box">
			<span><a href="<?php echo network_site_url( '' ) ?>"><img src="<?php echo get_template_directory_uri(); ?>/camouflage/forcenter/images/logo-ford.png" alt="Forcenter" title="Forcenter"/></a></span>
			<div class="sea">
